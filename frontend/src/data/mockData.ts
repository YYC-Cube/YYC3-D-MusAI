...
export const mockTracks: Track[] = [
  {
    ...
    album: '奉陪',
    cover: coverImages[0],
    audioUrl: `${MUSIC}/董小姐 和 沫言 - 奉陪.mp3`,
    duration: 234,
  },
  {
    id: '2',
    ...
    album: '岁月如歌',
    cover: coverImages[1],
    audioUrl: `${MUSIC}/董小姐 和 沫言 - 岁月如歌.mp3`,
    duration: 256,
  },
  {
    id: '3',
    ...
    album: '时光',
    cover: coverImages[2],
    audioUrl: `${MUSIC}/董小姐 和 沫言 - 时光.mp3`,
    duration: 218,
  },
  {
    id: '4',
    ...
    album: '浮生如渡',
    cover: coverImages[3],
    audioUrl: `${MUSIC}/董小姐 和 沫言 - 浮生如渡.mp3`,
    duration: 242,
  },
  {
    id: '5',
    ...
    album: '渡心时序',
    cover: coverImages[4],
    audioUrl: `${MUSIC}/董小姐 和 沫言 - 渡心时序.mp3`,
    duration: 228,
  },
  {
    id: '6',
